...
" Show eslint fix actions dropdown
...
let g:coc_global_extensions = ['coc-eslint', 'coc-json', 'coc-pairs', 'coc-prettier', 'coc-tailwindcss', 'coc-tsserver', 'coc-emmet', 'coc-prisma', 'coc-svelte']
